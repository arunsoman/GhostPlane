...
type xdpMapSpecs struct {
	BackendPool       *ebpf.MapSpec `ebpf:"backend_pool"`
	FrontendListeners *ebpf.MapSpec `ebpf:"frontend_listeners"`
	RrCounter         *ebpf.MapSpec `ebpf:"rr_counter"`
...
// It can be passed to loadXdpObjects or ebpf.CollectionSpec.LoadAndAssign.
type xdpMaps struct {
	BackendPool       *ebpf.Map `ebpf:"backend_pool"`
	FrontendListeners *ebpf.Map `ebpf:"frontend_listeners"`
	RrCounter         *ebpf.Map `ebpf:"rr_counter"`
